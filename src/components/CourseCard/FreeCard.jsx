    ...
    return (
        <button className="bg-white w-[323px] h-[250px] rounded-2xl flex flex-col" style={{ boxShadow: '0px 4px 10px 0px rgba(0, 0, 0, 0.08)' }}>
            ...
            <div className="w-[320px] px-3 py-3">
                ...
                <div className="bg-DARKBLUE05 text-white flex justify-between px-4 py-1 mt-3" style={{borderRadius: '15px', width: '115px'}}>
                    <div className="flex gap-1">
                        <p className="text-sm font-medium">Mulai Kelas</p>
                    </div>
                </div>
            </div>
        </button>
